-- Client-side head hitbox expand for other players (Size + near-invisible).
-- Vector supports BasePart Size/Transparency writes (same path as fly duck root.Size).
...
-- [head_addr] = { sx, sy, sz, transp, owned = true }
local tracked = {}
local was_on = false
