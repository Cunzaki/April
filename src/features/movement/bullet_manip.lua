...
function M.register_menu()
    ...
    menu.add_checkbox(T, G.MISC, "april_bullet_manip_debug", "Bullet Debug Overlay", false, root)
    menu.add_checkbox(T, G.MISC, "april_bullet_manip_console", "Bullet Debug Console", false, root)
    menu.add_checkbox(T, G.MISC, "april_bullet_manip_vis", "Bullet Visualizer", false, root)
    ...
    menu.add_checkbox(T, G.MISC, "april_bullet_manip_vis_link", "Bullet Show Link Line", false, root)
    menu.add_checkbox(T, G.MISC, "april_bullet_manip_vis_labels", "Bullet Show Labels", false, root)
    menu.add_checkbox(T, G.MISC, "april_bullet_manip_vis_peek", "Bullet Show Peek Point", false, root)
