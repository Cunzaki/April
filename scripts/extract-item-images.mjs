#!/usr/bin/env node
/**
 * Parse references/dump Items module → src/game/item_images.lua + assets/manifest.json
...
const DUMP = path.join(
  ROOT,
  "references/dump/scripts/ReplicatedStorage.Modules.Items.ModuleScript.lua",
);
