...
local urls = {
    "https://cdn.jsdelivr.net/gh/Cunzaki/April@main/april.lua?v=3.85.36&cb=" .. tostring(tick),
    "https://raw.githubusercontent.com/Cunzaki/April/refs/heads/main/april.lua?v=3.85.36&cb=" .. tostring(tick),
}
